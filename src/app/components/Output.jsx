		...
		return(
			...
			<div>
				...
				<Col className="socialBlock">
				    <a className={"fb-xfbml-parse-ignore socialShare"} target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnews.vice.com%2Fstory%2Fhow-much-should-i-be-making&amp;src=sdkpreparse">
					...
					<TwitterButton 
                        ...
                        url="https://news.vice.com/story/how-much-should-i-be-making"
                        element="a"
                        className="socialShare">
                        <i className={"fa fa-twitter fa-3x"} aria-hidden="true"/>
                    </TwitterButton>
                    <a 
	                    href="mailto:?subject=Vice%20Money%20Article&amp;body=How%20much%20should%20you%20be%20getting%20paid%3F%20Find%20out%20with%20the%20VICE%20Money%20Salary%20Calculator%3A%20https%3A%2F%2Fnews.vice.com%2Fstory%2Fhow-much-should-i-be-making"
	                    title="Send email">
