exports.titles = [
  {label: 'All Occupations', value: 'All Occupations'},
  {label: 'Management Occupations', value: 'Management Occupations'},
  {label: 'Chief Executives', value: 'Chief Executives'},
  ...
  {label: 'Sales Managers', value: 'Sales Managers'},
  ...
  {label: 'Food Service Managers', value: 'Food Service Managers'},
  {label: 'Lodging Managers', value: 'Lodging Managers'},
  {label: 'Medical and Health Services Managers',
  value: 'Medical and Health Services Managers'},
  {label: 'Natural Sciences Managers', value: 'Natural Sciences Managers'},
  ...
  {label: 'Managers, All Other', value: 'Managers, All Other'},
  ...
  {label: 'Cost Estimators', value: 'Cost Estimators'},
  ...
  {label: 'Logisticians', value: 'Logisticians'},
  {label: 'Management Analysts', value: 'Management Analysts'},
  ...
  {label: 'Budget Analysts', value: 'Budget Analysts'},
  {label: 'Financial Analysts', value: 'Financial Analysts'},
  {label: 'Personal Financial Advisors',
  value: 'Personal Financial Advisors'},
  {label: 'Insurance Underwriters', value: 'Insurance Underwriters'},
  {label: 'Financial Examiners', value: 'Financial Examiners'},
  {label: 'Loan Officers', value: 'Loan Officers'},
  {label: 'Tax Examiners and Collectors, and Revenue Agents',
  value: 'Tax Examiners and Collectors, and Revenue Agents'},
  {label: 'Tax Preparers', value: 'Tax Preparers'},
  ...
  {label: 'Computer Systems Analysts', value: 'Computer Systems Analysts'},
  {label: 'Information Security Analysts',
  value: 'Information Security Analysts'},
  {label: 'Computer Programmers', value: 'Computer Programmers'},
  ...
  {label: 'Environmental Engineers', value: 'Environmental Engineers'},
  ...
  {label: 'Industrial Engineers', value: 'Industrial Engineers'},
  ...
  {label: 'Petroleum Engineers', value: 'Petroleum Engineers'},
  {label: 'Engineers, All Other', value: 'Engineers, All Other'},
  ...
  {label: 'Drafters, All Other', value: 'Drafters, All Other'},
  ...
  {label: 'Conservation Scientists', value: 'Conservation Scientists'},
  ...
  {label: 'Hydrologists', value: 'Hydrologists'},
  ...
  {label: 'Psychologists, All Other', value: 'Psychologists, All Other'},
  ...
  {label: 'Biological Technicians', value: 'Biological Technicians'},
  ...
  {label: 'Mental Health Counselors', value: 'Mental Health Counselors'},
  {label: 'Rehabilitation Counselors', value: 'Rehabilitation Counselors'},
  {label: 'Counselors, All Other', value: 'Counselors, All Other'},
  ...
  {label: 'Social Workers, All Other', value: 'Social Workers, All Other'},
  ...
  {label: 'Legal Occupations', value: 'Legal Occupations'},
  ...
  {label: 'Producers and Directors', value: 'Producers and Directors'},
  {label: 'Coaches and Scouts', value: 'Coaches and Scouts'},
  ...
  {label: 'Writers and Authors', value: 'Writers and Authors'},
  ...
  {label: 'Broadcast Technicians', value: 'Broadcast Technicians'},
  {label: 'Photographers', value: 'Photographers'},
  {label: 'Film and Video Editors', value: 'Film and Video Editors'},
  ...
  {label: 'Dentists, General', value: 'Dentists, General'},
  ...
  {label: 'Internists, General', value: 'Internists, General'},
  ...
  {label: 'Physician Assistants', value: 'Physician Assistants'},
  {label: 'Occupational Therapists', value: 'Occupational Therapists'},
  {label: 'Physical Therapists', value: 'Physical Therapists'},
  {label: 'Respiratory Therapists', value: 'Respiratory Therapists'},
  ...
  {label: 'Nurse Practitioners', value: 'Nurse Practitioners'},
  ...
  {label: 'Dental Hygienists', value: 'Dental Hygienists'},
  ...
  {label: 'Radiologic Technologists', value: 'Radiologic Technologists'},
  ...
  {label: 'Pharmacy Technicians', value: 'Pharmacy Technicians'},
  {label: 'Psychiatric Technicians', value: 'Psychiatric Technicians'},
  {label: 'Surgical Technologists', value: 'Surgical Technologists'},
  ...
  {label: 'Opticians, Dispensing', value: 'Opticians, Dispensing'},
  ...
  {label: 'Home Health Aides', value: 'Home Health Aides'},
  {label: 'Psychiatric Aides', value: 'Psychiatric Aides'},
  {label: 'Nursing Assistants', value: 'Nursing Assistants'},
  {label: 'Physical Therapist Assistants',
  value: 'Physical Therapist Assistants'},
  {label: 'Massage Therapists', value: 'Massage Therapists'},
  {label: 'Dental Assistants', value: 'Dental Assistants'},
  {label: 'Medical Assistants', value: 'Medical Assistants'},
  {label: 'Medical Equipment Preparers',
  value: 'Medical Equipment Preparers'},
  {label: 'Medical Transcriptionists', value: 'Medical Transcriptionists'},
  {label: 'Pharmacy Aides', value: 'Pharmacy Aides'},
  {label: 'Veterinary Assistants and Laboratory Animal Caretakers',
  value: 'Veterinary Assistants and Laboratory Animal Caretakers'},
  {label: 'Phlebotomists', value: 'Phlebotomists'},
  ...
  {label: 'Crossing Guards', value: 'Crossing Guards'},
  ...
  {label: 'Chefs and Head Cooks', value: 'Chefs and Head Cooks'},
  ...
  {label: 'Cooks, Fast Food', value: 'Cooks, Fast Food'},
  {label: 'Cooks, Institution and Cafeteria',
  value: 'Cooks, Institution and Cafeteria'},
  {label: 'Cooks, Restaurant', value: 'Cooks, Restaurant'},
  {label: 'Cooks, Short Order', value: 'Cooks, Short Order'},
  {label: 'Cooks, All Other', value: 'Cooks, All Other'},
  {label: 'Food Preparation Workers', value: 'Food Preparation Workers'},
  ...
  {label: 'Waiters and Waitresses', value: 'Waiters and Waitresses'},
  ...
  {label: 'Nonfarm Animal Caretakers', value: 'Nonfarm Animal Caretakers'},
  ...
  {label: 'Skincare Specialists', value: 'Skincare Specialists'},
  {label: 'Baggage Porters and Bellhops',
  value: 'Baggage Porters and Bellhops'},
  {label: 'Concierges', value: 'Concierges'},
  {label: 'Tour Guides and Escorts', value: 'Tour Guides and Escorts'},
  {label: 'Childcare Workers', value: 'Childcare Workers'},
  {label: 'Personal Care Aides', value: 'Personal Care Aides'},
  {label: 'Fitness Trainers and Aerobics Instructors',
  value: 'Fitness Trainers and Aerobics Instructors'},
  {label: 'Recreation Workers', value: 'Recreation Workers'},
  {label: 'Residential Advisors', value: 'Residential Advisors'},
  ...
  {label: 'Counter and Rental Clerks', value: 'Counter and Rental Clerks'},
  {label: 'Parts Salespersons', value: 'Parts Salespersons'},
  {label: 'Retail Salespersons', value: 'Retail Salespersons'},
  {label: 'Advertising Sales Agents', value: 'Advertising Sales Agents'},
  {label: 'Insurance Sales Agents', value: 'Insurance Sales Agents'},
  ...
  {label: 'Real Estate Sales Agents', value: 'Real Estate Sales Agents'},
  {label: 'Sales Engineers', value: 'Sales Engineers'},
  ...
  {label: 'Procurement Clerks', value: 'Procurement Clerks'},
  {label: 'Tellers', value: 'Tellers'},
  {label: 'Financial Clerks, All Other',
  value: 'Financial Clerks, All Other'},
  {label: 'Brokerage Clerks', value: 'Brokerage Clerks'},
  ...
  {label: 'File Clerks', value: 'File Clerks'},
  ...
  {label: 'Order Clerks', value: 'Order Clerks'},
  ...
  {label: 'Cargo and Freight Agents', value: 'Cargo and Freight Agents'},
  ...
  {label: 'Postal Service Clerks', value: 'Postal Service Clerks'},
  ...
  {label: 'Legal Secretaries', value: 'Legal Secretaries'},
  {label: 'Medical Secretaries', value: 'Medical Secretaries'},
  ...
  {label: 'Computer Operators', value: 'Computer Operators'},
  {label: 'Data Entry Keyers', value: 'Data Entry Keyers'},
  ...
  {label: 'Office Clerks, General', value: 'Office Clerks, General'},
  ...
  {label: 'Construction Laborers', value: 'Construction Laborers'},
  {label: 'Pile-Driver Operators', value: 'Pile-Driver Operators'},
  ...
  {label: 'Sheet Metal Workers', value: 'Sheet Metal Workers'},
  {label: 'Structural Iron and Steel Workers',
  value: 'Structural Iron and Steel Workers'},
  {label: 'Helpers--Carpenters', value: 'Helpers--Carpenters'},
  {label: 'Helpers--Electricians', value: 'Helpers--Electricians'},
  ...
  {label: 'Roustabouts, Oil and Gas', value: 'Roustabouts, Oil and Gas'},
  ...
  {label: 'Avionics Technicians', value: 'Avionics Technicians'},
  ...
  {label: 'Motorcycle Mechanics', value: 'Motorcycle Mechanics'},
  ...
  {label: 'Home Appliance Repairers', value: 'Home Appliance Repairers'},
  ...
  {label: 'Team Assemblers', value: 'Team Assemblers'},
  {label: 'Assemblers and Fabricators, All Other',
  value: 'Assemblers and Fabricators, All Other'},
  {label: 'Bakers', value: 'Bakers'},
  {label: 'Butchers and Meat Cutters', value: 'Butchers and Meat Cutters'},
  {label: 'Food Batchmakers', value: 'Food Batchmakers'},
  ...
  {label: 'Printing Press Operators', value: 'Printing Press Operators'},
  ...
  {label: 'Power Plant Operators', value: 'Power Plant Operators'},
  ...
  {label: 'Gas Plant Operators', value: 'Gas Plant Operators'},
  ...
  {label: 'Commercial Pilots', value: 'Commercial Pilots'},
  {label: 'Air Traffic Controllers', value: 'Air Traffic Controllers'},
  {label: 'Airfield Operations Specialists',
  value: 'Airfield Operations Specialists'},
  {label: 'Flight Attendants', value: 'Flight Attendants'},
  ...
  {label: 'Driver/Sales Workers', value: 'Driver/Sales Workers'},
  ...
  {label: 'Sailors and Marine Oilers', value: 'Sailors and Marine Oilers'},
  {label: 'Captains, Mates, and Pilots of Water Vessels',
  value: 'Captains, Mates, and Pilots of Water Vessels'},
  {label: 'Ship Engineers', value: 'Ship Engineers'},
  {label: 'Parking Lot Attendants', value: 'Parking Lot Attendants'},
  {label: 'Automotive and Watercraft Service Attendants',
  value: 'Automotive and Watercraft Service Attendants'},
  {label: 'Transportation Inspectors', value: 'Transportation Inspectors'},
  ...
  {label: 'Mechanical Drafters', value: 'Mechanical Drafters'},
  {label: 'Chemical Technicians', value: 'Chemical Technicians'},
  ...
  {label: 'Pipelayers', value: 'Pipelayers'},
  ...
  {label: 'Tool and Die Makers', value: 'Tool and Die Makers'},
  ...
  {label: 'Sewing Machine Operators', value: 'Sewing Machine Operators'},
  ...
  {label: 'Athletic Trainers', value: 'Athletic Trainers'},
  ...
  {label: 'Legislators', value: 'Legislators'},
  ...
  {label: 'Credit Analysts', value: 'Credit Analysts'},
  {label: 'Actuaries', value: 'Actuaries'},
  {label: 'Statisticians', value: 'Statisticians'},
  {label: 'Biomedical Engineers', value: 'Biomedical Engineers'},
  {label: 'Materials Engineers', value: 'Materials Engineers'},
  ...
  {label: 'Court Reporters', value: 'Court Reporters'},
  ...
  {label: 'Art Directors', value: 'Art Directors'},
  ...
  {label: 'Broadcast News Analysts', value: 'Broadcast News Analysts'},
  ...
  {label: 'Orthodontists', value: 'Orthodontists'},
  {label: 'Anesthesiologists', value: 'Anesthesiologists'},
  {label: 'Pediatricians, General', value: 'Pediatricians, General'},
  {label: 'Psychiatrists', value: 'Psychiatrists'},
  {label: 'Radiation Therapists', value: 'Radiation Therapists'},
  {label: 'Recreational Therapists', value: 'Recreational Therapists'},
  {label: 'Nurse Anesthetists', value: 'Nurse Anesthetists'},
  {label: 'Audiologists', value: 'Audiologists'},
  ...
  {label: 'Orderlies', value: 'Orderlies'},
  ...
  {label: 'Physical Therapist Aides', value: 'Physical Therapist Aides'},
  ...
  {label: 'Telemarketers', value: 'Telemarketers'},
  {label: 'Correspondence Clerks', value: 'Correspondence Clerks'},
  {label: 'New Accounts Clerks', value: 'New Accounts Clerks'},
  {label: 'Meter Readers, Utilities', value: 'Meter Readers, Utilities'},
  ...
  {label: 'Boilermakers', value: 'Boilermakers'},
  ...
  {label: 'Tile and Marble Setters', value: 'Tile and Marble Setters'},
  ...
  {label: 'Helpers--Roofers', value: 'Helpers--Roofers'},
  ...
  {label: 'Roof Bolters, Mining', value: 'Roof Bolters, Mining'},
  ...
  {label: 'Mechanical Door Repairers', value: 'Mechanical Door Repairers'},
  {label: 'Millwrights', value: 'Millwrights'},
  ...
  {label: 'Crane and Tower Operators', value: 'Crane and Tower Operators'},
  ...
  {label: 'Agricultural Inspectors', value: 'Agricultural Inspectors'},
  {label: 'Food Cooking Machine Operators and Tenders',
  value: 'Food Cooking Machine Operators and Tenders'},
  {label: 'Tree Trimmers and Pruners', value: 'Tree Trimmers and Pruners'},
  {label: 'Woodworkers, All Other', value: 'Woodworkers, All Other'},
  ...
  {label: 'Nuclear Engineers', value: 'Nuclear Engineers'},
  ...
  {label: 'Physicists', value: 'Physicists'},
  {label: 'Materials Scientists', value: 'Materials Scientists'},
  ...
  {label: 'Commercial Divers', value: 'Commercial Divers'},
  ...
  {label: 'Archivists', value: 'Archivists'},
  {label: 'Gaming Supervisors', value: 'Gaming Supervisors'},
  ...
  {label: 'Log Graders and Scalers', value: 'Log Graders and Scalers'},
  ...
  {label: 'Rock Splitters, Quarry', value: 'Rock Splitters, Quarry'},
  ...
  {label: 'Animal Trainers', value: 'Animal Trainers'},
  {label: 'Agricultural Equipment Operators',
  value: 'Agricultural Equipment Operators'},
  {label: 'Credit Counselors', value: 'Credit Counselors'},
  {label: 'Biochemists and Biophysicists',
  value: 'Biochemists and Biophysicists'},
  {label: 'Microbiologists', value: 'Microbiologists'},
  {label: 'Epidemiologists', value: 'Epidemiologists'},
  {label: 'Economists', value: 'Economists'},
  {label: 'Judicial Law Clerks', value: 'Judicial Law Clerks'},
  ...
  {label: 'Dietetic Technicians', value: 'Dietetic Technicians'},
  ...
  {label: 'Funeral Service Managers', value: 'Funeral Service Managers'},
  ...
  {label: 'Soil and Plant Scientists', value: 'Soil and Plant Scientists'},
  {label: 'Survey Researchers', value: 'Survey Researchers'},
  {label: 'Political Scientists', value: 'Political Scientists'},
  ...
  {label: 'Craft Artists', value: 'Craft Artists'},
  {label: 'Set and Exhibit Designers', value: 'Set and Exhibit Designers'},
  {label: 'Designers, All Other', value: 'Designers, All Other'},
  ...
  {label: 'Exercise Physiologists', value: 'Exercise Physiologists'},
  {label: 'Therapists, All Other', value: 'Therapists, All Other'},
  {label: 'Hearing Aid Specialists', value: 'Hearing Aid Specialists'},
  {label: 'Fish and Game Wardens', value: 'Fish and Game Wardens'},
  ...
  {label: 'Embalmers', value: 'Embalmers'},
  {label: 'Telephone Operators', value: 'Telephone Operators'},
  {label: 'Gaming Cage Workers', value: 'Gaming Cage Workers'},
  {label: 'Desktop Publishers', value: 'Desktop Publishers'},
  {label: 'Statistical Assistants', value: 'Statistical Assistants'},
  ...
  {label: 'Tapers', value: 'Tapers'},
  {label: 'Paperhangers', value: 'Paperhangers'},
  ...
  {label: 'Rail Car Repairers', value: 'Rail Car Repairers'},
  {label: 'Bicycle Repairers', value: 'Bicycle Repairers'},
  {label: 'Camera and Photographic Equipment Repairers',
  value: 'Camera and Photographic Equipment Repairers'},
  {label: 'Watch Repairers', value: 'Watch Repairers'},
  ...
  {label: 'Furniture Finishers', value: 'Furniture Finishers'},
  {label: 'Chemical Plant and System Operators',
  value: 'Chemical Plant and System Operators'},
  {label: 'Semiconductor Processors', value: 'Semiconductor Processors'},
  {label: 'Etchers and Engravers', value: 'Etchers and Engravers'},
  {label: 'Railroad Conductors and Yardmasters',
  value: 'Railroad Conductors and Yardmasters'},
  {label: 'Traffic Technicians', value: 'Traffic Technicians'},
  ...
  {label: 'Nuclear Technicians', value: 'Nuclear Technicians'},
  ...
  {label: 'Nurse Midwives', value: 'Nurse Midwives'},
  {label: 'Genetic Counselors', value: 'Genetic Counselors'},
  ...
  {label: 'Sewers, Hand', value: 'Sewers, Hand'},
  ...
  {label: 'Farm Labor Contractors', value: 'Farm Labor Contractors'},
  {label: 'Wind Turbine Service Technicians',
  value: 'Wind Turbine Service Technicians'},
  {label: 'Wellhead Pumpers', value: 'Wellhead Pumpers'},
  {label: 'Agricultural Engineers', value: 'Agricultural Engineers'},
  {label: 'Gaming Dealers', value: 'Gaming Dealers'},
  {label: 'Mathematicians', value: 'Mathematicians'},
  {label: 'Sociologists', value: 'Sociologists'},
  ...
  {label: 'Choreographers', value: 'Choreographers'},
  ...
  {label: 'Costume Attendants', value: 'Costume Attendants'},
  ...
  {label: 'Shampooers', value: 'Shampooers'},
  ...
  {label: 'Gaming Managers', value: 'Gaming Managers'},
  {label: 'Slot Supervisors', value: 'Slot Supervisors'},
  {label: 'Historians', value: 'Historians'},
  ...
  {label: 'Geographers', value: 'Geographers'},
  ...
  {label: 'Radio Operators', value: 'Radio Operators'},
  ...
  {label: 'Locomotive Engineers', value: 'Locomotive Engineers'},
  {label: 'Motorboat Operators', value: 'Motorboat Operators'},
  {label: 'Manufactured Building and Mobile Home Installers',
  value: 'Manufactured Building and Mobile Home Installers'},
  {label: 'Mathematical Technicians', value: 'Mathematical Technicians'},
  {label: 'Animal Scientists', value: 'Animal Scientists'},
  ...
  {label: 'Model Makers, Wood', value: 'Model Makers, Wood'},
  {label: 'Bridge and Lock Tenders', value: 'Bridge and Lock Tenders'},
  {label: 'Hoist and Winch Operators', value: 'Hoist and Winch Operators'},
  {label: 'Dredge Operators', value: 'Dredge Operators'},
  {label: 'Gas Compressor and Gas Pumping Station Operators',
  value: 'Gas Compressor and Gas Pumping Station Operators'},
  {label: 'Fallers', value: 'Fallers'},
  {label: 'Mining Machine Operators, All Other',
  value: 'Mining Machine Operators, All Other'},
  {label: 'Patternmakers, Wood', value: 'Patternmakers, Wood'},
